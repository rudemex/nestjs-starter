...
var CharactersService = /** @class */ (function () {
    function CharactersService(appConfig, httpClient) {
        this.appConfig = appConfig;
        this.httpClient = httpClient;
    }
    CharactersService.prototype.getCharacter = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.httpClient
                            .get(encodeURI(this.appConfig.services.rickAndMortyAPI + "/character"), { params: params })
                            .toPromise()
    ...
    CharactersService = __decorate([
        common_1.Injectable(),
        __param(0, common_1.Inject(_config_1["default"].KEY))
    ], CharactersService);
